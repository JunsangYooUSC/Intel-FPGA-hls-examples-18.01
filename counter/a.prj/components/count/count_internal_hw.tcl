...
add_fileset_file count_function_wrapper.sv SYSTEM_VERILOG PATH ip/count_function_wrapper.sv
add_fileset_file count_function.sv SYSTEM_VERILOG PATH ip/count_function.sv
add_fileset_file count_bb_B0_runOnce.sv SYSTEM_VERILOG PATH ip/count_bb_B0_runOnce.sv
add_fileset_file count_bb_B0_runOnce_stall_region.sv SYSTEM_VERILOG PATH ip/count_bb_B0_runOnce_stall_region.sv
add_fileset_file count_B0_runOnce_merge_reg.sv SYSTEM_VERILOG PATH ip/count_B0_runOnce_merge_reg.sv
add_fileset_file count_i_llvm_fpga_pop_token_i1_wt_limpop_1.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_pop_token_i1_wt_limpop_1.sv
add_fileset_file count_i_llvm_fpga_pop_token_i1_wt_limpop_0_reg.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_pop_token_i1_wt_limpop_0_reg.sv
add_fileset_file count_i_llvm_fpga_push_token_i1_wt_limpush_4.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_push_token_i1_wt_limpush_4.sv
add_fileset_file count_i_llvm_fpga_push_token_i1_wt_limpush_3_reg.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_push_token_i1_wt_limpush_3_reg.sv
add_fileset_file count_B0_runOnce_branch.sv SYSTEM_VERILOG PATH ip/count_B0_runOnce_branch.sv
add_fileset_file count_B0_runOnce_merge.sv SYSTEM_VERILOG PATH ip/count_B0_runOnce_merge.sv
add_fileset_file count_bb_B1_start.sv SYSTEM_VERILOG PATH ip/count_bb_B1_start.sv
add_fileset_file count_bb_B1_start_stall_region.sv SYSTEM_VERILOG PATH ip/count_bb_B1_start_stall_region.sv
add_fileset_file count_i_iord_bl_do_unnamed_1_count23.sv SYSTEM_VERILOG PATH ip/count_i_iord_bl_do_unnamed_1_count23.sv
add_fileset_file count_i_iowr_bl_return_unnamed_2_count42.sv SYSTEM_VERILOG PATH ip/count_i_iowr_bl_return_unnamed_2_count42.sv
add_fileset_file count_B1_start_merge_reg.sv SYSTEM_VERILOG PATH ip/count_B1_start_merge_reg.sv
add_fileset_file count_i_sfc_s_c0_in_wt_entry_s_c0_enter1_count7.sv SYSTEM_VERILOG PATH ip/count_i_sfc_s_c0_in_wt_entry_s_c0_enter1_count7.sv
add_fileset_file count_i_llvm_fpga_sfc_exit_s_c0_out_wt_entry_s_c0_exit_count19.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_sfc_exit_s_c0_out_wt_entry_s_c0_exit_count19.sv
add_fileset_file count_i_sfc_logic_s_c0_in_wt_entry_s_c0_enter1_count8.sv SYSTEM_VERILOG PATH ip/count_i_sfc_logic_s_c0_in_wt_entry_s_c0_enter1_count8.sv
add_fileset_file count_i_llvm_fpga_pipeline_keep_going_12.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_pipeline_keep_going_12.sv
add_fileset_file count_i_llvm_fpga_push_i1_notexitcond_15.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_push_i1_notexitcond_15.sv
add_fileset_file count_i_sfc_s_c1_in_wt_entry_s_c1_enter_count25.sv SYSTEM_VERILOG PATH ip/count_i_sfc_s_c1_in_wt_entry_s_c1_enter_count25.sv
add_fileset_file count_i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_s_c1_exit_count38.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_sfc_exit_s_c1_out_wt_entry_s_c1_exit_count38.sv
add_fileset_file count_i_sfc_logic_s_c1_in_wt_entry_s_c1_enter_count26.sv SYSTEM_VERILOG PATH ip/count_i_sfc_logic_s_c1_in_wt_entry_s_c1_enter_count26.sv
add_fileset_file count_i_llvm_fpga_pop_i32_zz5e3cnt_addr_0_pop3_count30.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_pop_i32_zz5e3cnt_addr_0_pop3_count30.sv
add_fileset_file count_i_llvm_fpga_push_i32_zz5e3cnt_addr_0_push3_count34.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_push_i32_zz5e3cnt_addr_0_push3_count34.sv
add_fileset_file count_B1_start_branch.sv SYSTEM_VERILOG PATH ip/count_B1_start_branch.sv
add_fileset_file count_B1_start_merge.sv SYSTEM_VERILOG PATH ip/count_B1_start_merge.sv
add_fileset_file count_i_llvm_fpga_pipeline_keep_going_11_sr.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_pipeline_keep_going_11_sr.sv
add_fileset_file count_i_llvm_fpga_pipeline_keep_going_11_valid_fifo.sv SYSTEM_VERILOG PATH ip/count_i_llvm_fpga_pipeline_keep_going_11_valid_fifo.sv
